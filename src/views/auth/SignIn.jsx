    ...
    <div className="flex items-center justify-center w-full h-full px-2 mt-16 mb-16 md:mx-0 md:px-0 lg:mb-10 lg:items-center lg:justify-start">
      <div className="mt-[10vh] w-full max-w-full flex-col items-center md:pl-4 lg:pl-0 xl:max-w-[420px]">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            className="linear active:[#f06739] mt-2 w-full rounded-xl bg-[#f06739] py-[12px] text-base font-medium text-white transition duration-200 hover:bg-[#f08b39] dark:bg-brand-400 dark:text-white dark:hover:bg-brand-300 dark:active:bg-brand-200"
            type="submit"
          >
            Se connecter
          </button>
